...
//  Krishna Patel - Comp Sci 40S - The S stands for Soon (for a new assignment!)
...
int getMark(spreadsheet mysheet)
{
	...
	if (howmany_a == 0)
		...
		if (howmany_tq == 0)
			...
			return (int)((100 * tot_results_tq / tot_possible_tq) * (0.5) +
				(100 * tot_results_a / tot_possible_a) * (0.5));
}  // getMark
